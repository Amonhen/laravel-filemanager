...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/amonhen-unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
{{--  </div>--}}
  ...
  <div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: unset;max-width: unset;margin: 0;padding: 0">
      <div class="modal-content">
...
{{--  </div>--}}
  ...
  <script>{!! \File::get(base_path('vendor/amonhen-unisharp/laravel-filemanager/public/js/script.js')) !!}</script>
